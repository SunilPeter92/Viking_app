          ...
          children: [
            ...
            Center(
              child: Text(
                "ACTIVATE YOUR",
                style: TextStyle(
                    fontWeight: FontWeight.bold, fontSize: width * 0.065),
              ),
            ),
            Center(
              child: Text(
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  "then \$300/ a week ",
                  style:
                      TextStyle(color: Colors.green, fontSize: width * 0.040),
                ),
              ],
            ),
            Row(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    "or",
                    style:
                        TextStyle(color: Colors.grey, fontSize: width * 0.040),
                  ),
                  SizedBox(
                    width: width * 0.01,
                  ),
              ...
              child: Container(
                ...
                child: FlatButton(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                          color: Colors.orange, fontSize: width * 0.045),
                    )),
              ),
            ),
            Row(
