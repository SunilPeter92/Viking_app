...
class StripPayment extends StatefulWidget {
  @override
  _StripPaymentState createState() => new _StripPaymentState();
}
...
class _StripPaymentState extends State<StripPayment> {
  ...
  String _error;
  final String _currentSecret = "sk_test_kFjl1gWRtcHTtZHXW0PZpxTn00Hcozdl8W"; //set this yourself, e.g using curl
